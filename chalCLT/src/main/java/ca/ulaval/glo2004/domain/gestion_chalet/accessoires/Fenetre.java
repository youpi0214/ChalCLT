...
public class Fenetre extends Accessoire implements Serializable {
    ...
    public Fenetre(Fenetre p_fenetre) {
        this(p_fenetre.getLargeur(), p_fenetre.getLongueur(), p_fenetre.getEpaisseur(), p_fenetre.getCoordonneesEmplacement(), p_fenetre.getMurEmplacement(), p_fenetre.getAccessoire_identification());
    }

    public Fenetre(UniteImperiale p_largeur, UniteImperiale p_longueur, UniteImperiale p_epaisseur, UniteImperiale[] p_coordonnesEmplacement, Orientations p_murEmplacement, int p_accessoire_identification) {
